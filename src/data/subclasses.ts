...
export const subclasses: Subclass[] = [
...

  {
    ...
    synopsis: "Your rage triggers unpredictable surges of wild magic, producing random beneficial effects like bolts of force, healing, or flight.",
    hint: "Good if you want chaotic magical effects mixed into your barbarian combat",
    source: "Tasha's Cauldron",
    features: [
      { level: 3, name: "Magic Awareness / Wild Surge", description: "Sense active spells nearby as an action. Each time you rage, roll on the Wild Magic table for a random magical effect — bolts of force, invisibility, flight, and more." },
      { level: 6, name: "Bolstering Magic", description: "Touch an ally to give them a bonus to attack rolls and ability checks, or let them regain a spent spell slot up to 3rd level. Usable on yourself." },
      { level: 10, name: "Unstable Backlash", description: "When you take damage or fail a save while raging, use your reaction to roll on the Wild Magic table for an immediate surge." },
      { level: 14, name: "Controlled Surge", description: "When you roll on the Wild Magic table, roll twice and choose which result to use." },
    ],
  },
...

  {
    ...
    synopsis: "You are a seeker of lore, gaining expertise in skills, reading minds, and eventually stealing knowledge directly from other creatures.",
    hint: "Good if you want to be the most knowledgeable character at the table",
    source: "PHB",
    features: [
      { level: 1, name: "Blessings of Knowledge", description: "Gain proficiency in two skills from a list of lore-related options, and expertise (double proficiency) in both." },
      { level: 2, name: "Knowledge of the Ages", description: "Channel Divinity to gain proficiency in any skill or tool for 10 minutes." },
      { level: 6, name: "Read Thoughts", description: "Channel Divinity to read a creature's surface thoughts for 1 minute, then cast Suggestion against it for free." },
      { level: 17, name: "Visions of the Past", description: "Meditate to receive visions about an object you hold or the area around you, learning its recent history." },
    ],
  },
  {
    id: "nature-domain",
    classId: "cleric",
    name: "Nature Domain",
    synopsis: "You are a divine protector of nature, charming animals, dampening enemy spells, and gaining heavy armor while wielding nature's power.",
    hint: "Good if you want a nature-flavored cleric with druid-like spells",
    source: "PHB",
    features: [
      { level: 1, name: "Acolyte of Nature", description: "Learn a druid cantrip and gain proficiency in one nature-related skill." },
      { level: 2, name: "Charm Animals and Plants", description: "Channel Divinity to charm all beasts and plant creatures within 30 feet for 1 minute." },
      { level: 6, name: "Dampen Elements", description: "As a reaction, grant resistance to acid, cold, fire, lightning, or thunder damage to an ally within 30 feet." },
      { level: 17, name: "Master of Nature", description: "When you use Charm Animals and Plants, you can command charmed creatures with a bonus action." },
    ],
  },
  {
    id: "tempest-domain",
    classId: "cleric",
    name: "Tempest Domain",
    synopsis: "You wield the fury of storms, wearing heavy armor, maximizing lightning and thunder damage, and knocking enemies back with thunder.",
    hint: "Good if you want a heavily armored cleric who blasts with lightning",
    source: "PHB",
    features: [
      { level: 1, name: "Wrath of the Storm", description: "As a reaction when hit, deal 2d8 lightning or thunder damage to the attacker (Dex save for half). Wisdom mod uses per long rest." },
      { level: 2, name: "Destructive Wrath", description: "Channel Divinity to deal maximum damage instead of rolling when you deal lightning or thunder damage." },
      ...
      { level: 17, name: "Stormborn", description: "Gain a flying speed equal to your walking speed whenever you're not underground or indoors." },
    ],
  },
  {
    id: "trickery-domain",
    ...
    synopsis: "You are a divine trickster who creates illusory duplicates, makes allies invisible, and eventually swaps places with your shadow clone.",
    hint: "Good if you want a sneaky, deceptive cleric focused on misdirection",
    source: "PHB",
    features: [
      { level: 1, name: "Blessing of the Trickster", description: "Touch a willing creature to give it advantage on Dexterity (Stealth) checks for 1 hour." },
      { level: 2, name: "Invoke Duplicity", description: "Channel Divinity to create an illusory duplicate. Allies attacking targets near your duplicate have advantage." },
      { level: 6, name: "Cloak of Shadows", description: "Channel Divinity to turn invisible until the end of your next turn or until you attack, deal damage, or force a save." },
      { level: 17, name: "Improved Duplicity", description: "Create four duplicates with Invoke Duplicity instead of one, and you can move them up to 30 feet each as a bonus action." },
    ],
  },
  {
    id: "war-domain",
    classId: "cleric",
    name: "War Domain",
    synopsis: "You are a divine warrior who makes bonus attacks, boosts attack rolls, and gains extra attacks to stand toe-to-toe with fighters.",
    hint: "Good if you want a martial cleric that fights in melee alongside the party",
    source: "PHB",
    features: [
      { level: 1, name: "War Priest", description: "Your deity empowers your strikes — make one weapon attack as a bonus action. Wisdom mod uses per long rest." },
      { level: 2, name: "Guided Strike", description: "Channel Divinity to add +10 to an attack roll you make, potentially turning a miss into a hit." },
      { level: 6, name: "War God's Blessing", description: "Use your reaction to grant an ally within 30 feet the +10 attack roll bonus from Guided Strike." },
      { level: 17, name: "Avatar of Battle", description: "Gain resistance to nonmagical bludgeoning, piercing, and slashing damage." },
    ],
  },
  {
    id: "twilight-domain",
    ...
    synopsis: "You stand at the border of day and night, granting your allies darkvision and sanctuary in a magical twilight aura as you channel your divinity.",
    hint: "Good if you want powerful party-wide buffs and battlefield control",
    source: "Tasha's Cauldron",
    features: [
      { level: 1, name: "Eyes of Night", description: "You have darkvision with no range limit. As an action, share darkvision (300 ft) with willing allies for 1 hour. Once per long rest." },
      { level: 2, name: "Twilight Sanctuary", description: "Channel Divinity to create a 30-foot radius sphere for 1 minute — allies ending their turn inside gain temp HP or end the frightened or charmed condition." },
      { level: 6, name: "Steps of Night", description: "When in dim light or darkness, use a bonus action to fly for 1 minute. Wisdom mod uses per long rest." },
      { level: 17, name: "Twilight Shroud", description: "Allies inside your Twilight Sanctuary gain half cover." },
    ],
  },
  {
    id: "order-domain",
    classId: "cleric",
    name: "Order Domain",
    synopsis: "You enforce divine law, compelling obedience, triggering ally attacks when you cast spells, and dominating the minds of the disobedient.",
    hint: "Good if you want to control the battlefield by compelling actions from allies and enemies",
    source: "Tasha's Cauldron",
    features: [
      { level: 1, name: "Voice of Authority", description: "When you cast a spell using a slot on an ally, they can use their reaction to make one weapon attack." },
      { level: 2, name: "Order's Demand", description: "Channel Divinity to charm creatures within 30 feet — charmed creatures must drop whatever they're holding." },
      { level: 6, name: "Embodiment of the Law", description: "Cast enchantment spells of 1st level or higher as a bonus action if you haven't cast a bonus-action spell yet. Wisdom mod uses per long rest." },
      { level: 17, name: "Order's Wrath", description: "When you use Voice of Authority, the target is also cursed — the ally's attack becomes a divine smite dealing extra psychic damage until your next turn." },
    ],
  },
...

  {
    ...
    synopsis: "You stand with the forces of light and nature, trapping enemies in magical vines and becoming increasingly resistant to spells.",
    hint: "Good if you want a nature-flavored paladin who excels against casters",
    source: "PHB",
    features: [
      { level: 3, name: "Sacred Weapon / Nature's Wrath", description: "Sacred Weapon adds Charisma to attack rolls. Nature's Wrath uses Channel Divinity to restrain a creature in spectral vines (Str or Dex save to escape)." },
      { level: 7, name: "Aura of Warding", description: "You and allies within 10 feet (30 ft at level 18) have resistance to damage from spells." },
      { level: 15, name: "Undying Sentinel", description: "When you drop to 0 HP, you can instead drop to 1 HP. Once per long rest. Also, you don't suffer the aging effects of magic." },
      { level: 20, name: "Elder Champion", description: "Transform for 1 minute — regain 10 HP per turn, cast paladin spells as bonus actions, and enemies within 10 ft have disadvantage on saves against your spells." },
    ],
  },
  {
    ...
    synopsis: "You guard the mortal world against extraplanar threats, boosting your party's saves and banishing otherworldly creatures.",
    hint: "Good if you want an anti-extraplanar specialist with powerful save boosts",
    source: "Tasha's Cauldron",
    features: [
      { level: 3, name: "Watcher's Will / Abjure the Extraplanar", description: "Watcher's Will grants Charisma mod to saves for up to 5 allies for 1 minute. Abjure the Extraplanar banishes fey, fiends, celestials, elementals, or aberrations on a failed Wis save." },
      { level: 7, name: "Aura of the Sentinel", description: "You and allies within 10 feet (30 ft at level 18) add your proficiency bonus to initiative rolls." },
      { level: 15, name: "Vigilant Rebuke", description: "When you or an ally succeeds on an Intelligence, Wisdom, or Charisma save, deal 2d8 + Charisma force damage to the creature that forced the save." },
      { level: 20, name: "Mortal Bulwark", description: "Transform for 1 minute — advantage on attacks vs. aberrations/celestials/elementals/fey/fiends, advantage on saves vs. their spells/powers, and can cast Banishment on a hit (no concentration) once per turn." },
    ],
  },
...

  {
    ...
    synopsis: "You specialize in summoning creatures and objects, teleporting short distances, and eventually conjuring creatures faster and for longer.",
    hint: "Good if you want to summon allies and teleport around the battlefield",
    source: "PHB",
    features: [
      { level: 2, name: "Benign Transposition", description: "Teleport up to 30 feet to an unoccupied space you can see as a bonus action. Recharges when you cast a conjuration spell." },
      { level: 6, name: "Focused Conjuration", description: "Your concentration on conjuration spells can't be broken by taking damage." },
      { level: 10, name: "Durable Summons", description: "Creatures you conjure gain 30 temporary HP." },
      { level: 14, name: "Overflow Conjuration", description: "Cast conjuration spells of 1st through 5th level in 1 action instead of 1 minute, and summons last twice as long." },
    ],
  },
  {
    ...
    synopsis: "You peer into the future with Portent, rolling dice at the start of each day that you can substitute for any roll made by anyone.",
    hint: "Good if you want to control fate — guarantee successes and force failures",
    source: "PHB",
    features: [
      { level: 2, name: "Portent", description: "Roll two d20s after a long rest. Replace any attack roll, save, or ability check with one of these rolls — for you or anyone else." },
      { level: 6, name: "Expert Divination", description: "When you cast a divination spell of 2nd level or higher, regain one expended spell slot of a lower level." },
      { level: 10, name: "The Third Eye", description: "As an action, gain darkvision, see invisible creatures, read any language, or see into the Ethereal Plane until your next rest." },
      { level: 14, name: "Greater Portent", description: "You now roll three d20s for Portent instead of two." },
    ],
  },
  {
    ...
    synopsis: "You bend minds to your will, hypnotizing enemies and eventually turning charmed foes against their own allies.",
    hint: "Good if you want to charm and control enemies without killing them",
    source: "PHB",
    features: [
      { level: 2, name: "Hypnotic Gaze", description: "Use an action to charm a creature within 5 feet for 1 minute — it's incapacitated and has speed 0." },
      { level: 6, name: "Instinctive Charm", description: "As a reaction, redirect an attack against you to a different nearby creature." },
      { level: 10, name: "Split Enchantment", description: "When you cast an enchantment spell targeting one creature, you can target a second creature for free." },
      { level: 14, name: "Alter Memories", description: "After charming a creature, you can make it forget up to 1 hour of what it experienced while charmed." },
    ],
  },
  {
    ...
    synopsis: "You craft convincing illusions that can deal real damage, become nearly real, and eventually reshape a target's perception of reality.",
    hint: "Good if you want creative battlefield control through deception",
    source: "PHB",
    features: [
      { level: 2, name: "Improved Minor Illusion", description: "You learn Minor Illusion and can create both a sound and an image simultaneously with it." },
      { level: 6, name: "Malleable Illusions", description: "While concentrating on an illusion, use an action to change it to anything within the spell's parameters." },
      { level: 10, name: "Illusory Self", description: "When you're hit by an attack, use your reaction to interpose an illusory duplicate — the attack misses. Recharges on a short or long rest." },
      { level: 14, name: "Illusory Reality", description: "Once per round when you cast an illusion spell, choose one non-creature object within the illusion — it becomes real for 1 minute." },
    ],
  },
  {
    ...
    synopsis: "You raise undead armies, leech vitality from enemies, and make your undead minions tougher and more powerful.",
    hint: "Good if you want to command a horde of undead servants",
    source: "PHB",
    features: [
      { level: 2, name: "Grim Harvest", description: "When you kill a creature with a spell, regain HP equal to twice (or three times for undead/constructs) the spell's level." },
      { level: 6, name: "Undead Thralls", description: "Animate Dead creates one extra zombie or skeleton, and your undead have bonus HP and damage." },
      { level: 10, name: "Inured to Undeath", description: "Gain resistance to necrotic damage and your max HP can't be reduced." },
      { level: 14, name: "Command Undead", description: "Use your action to take control of any undead creature — it must succeed on a Charisma save or obey you." },
    ],
  },
  {
    ...
    synopsis: "You reshape matter and living beings, transforming materials into gold, buffing allies, and eventually polymorph-ing yourself at will.",
    hint: "Good if you want to transform the world around you and buff your party",
    source: "PHB",
    features: [
      { level: 2, name: "Minor Alchemy", description: "Transform a small amount of one material into another (wood, stone, iron, copper, or silver) for up to 1 hour." },
      { level: 6, name: "Transmuter's Stone", description: "Create a magic stone that grants one of several benefits: darkvision, extra speed, proficiency in Constitution saves, or elemental resistance." },
      { level: 10, name: "Shapechanger", description: "Cast Polymorph on yourself at will without expending a spell slot (you can only target yourself)." },
      { level: 14, name: "Master Transmuter", description: "Destroy your Transmuter's Stone to cast a major transformation — convert lead to gold, cast Raise Dead for free, or cure all ailments." },
    ],
  },
  {
    id: "order-of-scribes",
    ...
    synopsis: "Your spellbook is a sentient magical companion that can copy spells instantly, change spell damage types, and cast spells autonomously.",
    hint: "Good if you want a living spellbook and maximum spell flexibility",
    source: "Tasha's Cauldron",
    features: [
      { level: 2, name: "Awakened Spellbook", description: "Your spellbook becomes sentient — rituals take no extra time, you can swap a spell's damage type when casting, and it can manifest nearby." },
      { level: 6, name: "Manifest Mind", description: "Summon the spellbook's mind as a glowing spectral orb that you can move telepathically, see through, and use as the origin point for your spells." },
      { level: 10, name: "Master Scrivener", description: "Create a magical scroll from your spellbook spells at the end of a rest. The scroll casts at one level higher and decays after use." },
      { level: 14, name: "One with the Word", description: "While your spellbook is on your person, gain advantage on death saving throws. If you die, your spellbook can rewrite reality to bring you back — at the cost of some of your spells." },
    ],
  },
  {
    id: "chronurgy-magic",
    ...
    synopsis: "You manipulate time itself, bending initiative, freezing enemies in stasis, and rewriting the outcomes of failed rolls.",
    hint: "Good if you want to control time and rewrite bad dice rolls",
    source: "Explorer's Guide",
    features: [
      { level: 2, name: "Chronal Shift", description: "After a creature rolls an attack, check, or save, force it to reroll and use the new result. Usable twice per long rest." },
      { level: 6, name: "Temporal Awareness", description: "Add your Intelligence modifier to initiative rolls." },
      { level: 10, name: "Momentary Stasis", description: "As an action, freeze a Large or smaller creature in temporal stasis — it's incapacitated until the end of your next turn. Intelligence mod uses per long rest." },
      { level: 14, name: "Arcane Abeyance", description: "When you cast a 4th-level or lower spell, store it in a bead for up to 1 hour. Another creature can use their action to release the spell from the bead." },
    ],
  },
  {
    id: "graviturgy-magic",
    ...
    synopsis: "You bend gravity to slow enemies, hurl them through the air, and make yourself or your foes unnaturally heavy or light.",
    hint: "Good if you want to control enemy movement and positioning",
    source: "Explorer's Guide",
    features: [
      { level: 2, name: "Adjust Density", description: "As an action, double or halve a creature's weight — affecting speed, jumping, and whether it sinks or floats. Intelligence mod uses per long rest." },
      { level: 6, name: "Gravity Well", description: "Whenever you cast a spell on a creature, you can move it 5 feet to an unoccupied space." },
      { level: 10, name: "Violent Attraction", description: "As a reaction, increase the damage of one falling creature or one weapon attack by 1d10. Intelligence mod uses per long rest." },
      { level: 14, name: "Event Horizon", description: "As an action, emit a gravitational field for 1 minute — creatures starting their turn within 30 feet must make a Strength save or be restrained and take 2d10 force damage." },
    ],
  },
  ...
  },
  {
    ...
    synopsis: "A dwarven tradition of warriors clad in spiked armor who turn their own bodies into weapons, dealing damage just by grappling and crashing into foes.",
    hint: "Good if you want a spiky bruiser who punishes anyone foolish enough to get close.",
    source: "Sword Coast",
    features: [
      { level: 3, name: "Battlerager Armor", description: "While wearing spiked armor, you can use a bonus action to attack with its spikes and deal damage to creatures that grapple you." },
      { level: 6, name: "Reckless Abandon", description: "When you use Reckless Attack while raging, you gain temporary hit points equal to your Constitution modifier." },
      { level: 10, name: "Battlerager Charge", description: "You can take the Dash action as a bonus action while you are raging." },
      { level: 14, name: "Spiked Retribution", description: "When a creature within 5 feet of you hits you with a melee attack, it takes 3 piercing damage if you are raging and wearing spiked armor." },
    ],
  },
  {
    ...
    synopsis: "A storyteller who channels the whispers of the dead and otherworldly spirits, producing unpredictable magical tales through a spiritual focus.",
    hint: "Good if you want a spooky, randomized spellcaster who loves rolling on wild tables.",
    source: "Tasha's Cauldron",
    features: [
      { level: 3, name: "Guiding Whispers & Spiritual Focus", description: "You learn Guidance with a 60-foot range and can use a spiritual focus such as a candle, crystal ball, or talking board to channel spirit tales." },
      { level: 3, name: "Tales from Beyond", description: "As a bonus action, expend Bardic Inspiration and roll a d6 on the Spirit Tales table to produce a random magical effect you can unleash later." },
      { level: 6, name: "Spirit Session", description: "Through a one-hour ritual with allies, you gain an additional Spirit Tale use and temporarily learn a spell from a small spirit-themed list." },
      { level: 14, name: "Mystical Connection", description: "When you roll on the Spirit Tales table, you roll a d6 twice and choose which effect to use." },
    ],
  },
  {
    id: "college-of-the-road",
    classId: "bard",
    name: "College of the Road",
    synopsis: "A traveling entertainer who turns campfires and crossroads into stages, bolstering companions with rousing performances and hard-earned road skills.",
    hint: "Good if you want a wandering minstrel who buffs the party and holds their own in a fight.",
    source: "Critical Role",
    features: [
      { level: 3, name: "Enthralling Performance", description: "After performing for at least 10 minutes, you can grant nearby allies temporary hit points and a bonus to their next damage roll." },
      { level: 3, name: "Sharpshooter's Song", description: "You gain proficiency with martial weapons and medium armor, reflecting your hard-traveled life on the road." },
      { level: 6, name: "Traveler's Determination", description: "You can expend a use of Bardic Inspiration to reroll a failed saving throw, adding the inspiration die to the new roll." },
      { level: 14, name: "Vigor of the Road", description: "When you finish a performance, allies who listened can take the Dash or Disengage action as a bonus action on their next turn." },
    ],
  },
  {
    id: "college-of-masks",
    ...
    synopsis: "A theatrical performer who collects masks representing different personas, slipping between identities with illusion magic and acrobatic flair.",
    hint: "Good if you want a face-stealing trickster who thrives on disguises and misdirection.",
    source: "Critical Role",
    features: [
      { level: 3, name: "Mask of Many Faces", description: "You can cast Disguise Self at will, without expending a spell slot." },
      { level: 3, name: "Tumbling Fool", description: "As a bonus action, you can tumble to take the Dodge, Disengage, or Hide action." },
      { level: 6, name: "Trance of Three", description: "You attune to three mask personas, each granting a different boon you can invoke when you don that mask." },
      { level: 14, name: "Ensemble of One", description: "You can create multiple illusory duplicates of yourself that act in concert, confusing foes and sharing the spotlight." },
    ],
  },
  {
    id: "circle-of-stars",
    ...
    synopsis: "A druid who draws power from the constellations, assuming a luminous Starry Form modeled on the Archer, Chalice, or Dragon instead of beast shapes.",
    hint: "Good if you want a flexible caster-druid who swaps between ranged damage, healing, and concentration support.",
    source: "Tasha's Cauldron",
    features: [
      { level: 2, name: "Star Map & Starry Form", description: "You create a celestial Star Map and can use a bonus action to assume a Starry Form (Archer, Chalice, or Dragon), each granting a different benefit." },
      { level: 6, name: "Cosmic Omen", description: "At dawn, roll a d6 to determine your omen for the day - Weal or Woe - letting you use your reaction to add or subtract a d6 from rolls nearby." },
      { level: 10, name: "Twinkling Constellations", description: "Your Starry Forms improve, and you gain a flying speed of 20 feet while in a Starry Form." },
      { level: 14, name: "Full of Stars", description: "While in your Starry Form, you have resistance to bludgeoning, piercing, and slashing damage." },
    ],
  },
  {
    id: "circle-of-ash",
    classId: "druid",
    name: "Circle of Ash",
    synopsis: "A druid of cleansing fire and rebirth who embraces destruction as a part of nature's cycle, wreathed in flame and ready to rise from the ashes.",
    hint: "Good if you want a fiery druid who deals blazing damage and can literally come back from the dead.",
    source: "Kobold Press",
    features: [
      { level: 2, name: "Ashen Wildshape", description: "Your Wild Shape forms gain fire resistance and deal extra fire damage with their natural weapons." },
      { level: 6, name: "Ember Flare", description: "As a bonus action, you release a burst of radiant fire from your body, damaging creatures around you." },
      { level: 10, name: "Cinder Form", description: "You become immune to fire damage and leave a trail of flames in your wake that burns creatures that follow you." },
      { level: 14, name: "Phoenix Rebirth", description: "When you drop to 0 hit points, you can instead revive with a burst of flame, returning to life with hit points and damaging nearby enemies." },
    ],
  },
  {
    id: "circle-of-the-petal",
    classId: "druid",
    name: "Circle of the Petal",
    synopsis: "A druid devoted to blossoms, pollen, and the renewing promise of spring, leaving a trail of healing flowers wherever they walk.",
    hint: "Good if you want a gentle, support-focused druid with a whimsical floral theme.",
    source: "Obojima",
    features: [
      { level: 2, name: "Blooming Path", description: "Flowers bloom in your footsteps, releasing healing pollen that allies can gather as they pass." },
      { level: 6, name: "Petal Barrage", description: "You scatter a swirl of magical flower petals that damage enemies and restore hit points to allies caught in the cloud." },
      { level: 10, name: "Fragrant Aura", description: "You emanate a 30-foot aura granting allies resistance to being charmed and advantage on Wisdom saving throws." },
      { level: 14, name: "Eternal Spring", description: "Once per day, you can Wild Shape into a giant flower spirit, a powerful form that embodies the heart of spring." },
    ],
  },
  {
    ...
    synopsis: "A noble knight of Cormyr's royal guard who leads by example, inspiring allies in battle and serving as a diplomat off the field.",
    hint: "Good if you want a charismatic battlefield leader who buffs allies as much as they swing a sword.",
    source: "Sword Coast",
    features: [
      { level: 3, name: "Rallying Cry", description: "When you use Second Wind, you also heal up to three allies within 60 feet for 5 hit points." },
      { level: 7, name: "Royal Envoy", description: "You gain proficiency in Persuasion, and your proficiency bonus is doubled for any Persuasion check you make." },
      { level: 10, name: "Inspiring Surge", description: "When you use Action Surge, one ally within 60 feet can use their reaction to make a weapon attack." },
      { level: 15, name: "Bulwark", description: "When you use Indomitable to reroll a save, an ally within 60 feet who also failed a save can reroll it as well." },
    ],
  },
  {
    id: "echo-knight",
    classId: "fighter",
    name: "Echo Knight",
    synopsis: "A warrior from Wildemount who wields a spectral echo of themselves drawn from an unrealized timeline, striking from two places at once.",
    hint: "Good if you want a mobile, tactical fighter with a ghostly duplicate to outmaneuver enemies.",
    source: "Explorer's Guide",
    features: [
      { level: 3, name: "Manifest Echo", description: "You summon a magical echo of yourself within 15 feet that you can attack from and swap places with as a bonus action." },
      { level: 7, name: "Unleash Incarnation", description: "You can make one extra melee attack through your echo a number of times per long rest equal to your proficiency bonus." },
      { level: 10, name: "Echo Avatar", description: "You can see and hear through your echo for up to 10 minutes, projecting your senses up to 1,000 feet away." },
      { level: 15, name: "Shadow Martyr", description: "As a reaction, you can have your echo take a hit intended for an ally before the attack roll is made." },
    ],
  },
  {
    id: "gunslinger",
    classId: "fighter",
    name: "Gunslinger",
    synopsis: "A daring marksman who crafts and wields firearms, spending grit points to pull off legendary trick shots at the edge of possibility.",
    hint: "Good if you want a gun-toting sharpshooter with flashy, resource-driven special attacks.",
    source: "Critical Role",
    features: [
      { level: 3, name: "Firearm Proficiency & Gunsmith", description: "You gain proficiency with firearms and Tinker's Tools, allowing you to craft and repair your own guns." },
      { level: 3, name: "Adept Marksman", description: "You gain grit points that fuel trick shots such as Deadeye, Violent Shot, and Piercing Shot, each producing dramatic effects." },
      { level: 7, name: "Quick Draw", description: "You can stow and draw two firearms as part of a single action, and you add your proficiency bonus to initiative." },
      { level: 10, name: "Rapid Repair", description: "You can reload any firearm as a bonus action, keeping your shots flowing in the heat of battle." },
      { level: 15, name: "Lightning Reload", description: "Once per turn, you can reload a firearm as a free action, without using your action or bonus action." },
    ],
  },
  {
    id: "pugilist",
    classId: "fighter",
    name: "Pugilist",
    synopsis: "A bare-knuckle brawler who excels at grappling and bludgeoning foes into submission.",
    hint: "Good if you want to punch things, wrestle enemies, and skip weapons entirely",
    source: "Critical Role",
    features: [
      { level: 3, name: "Unarmed Fighter", description: "Unarmed strikes deal 1d6 + Strength damage, and you can attempt to grapple as a bonus action." },
      { level: 7, name: "Brutal Brawler", description: "Gain advantage on grapple checks, and creatures you grapple take bludgeoning damage each turn they remain grappled." },
      { level: 10, name: "Two-Fisted Technique", description: "When you take the Attack action with an unarmed strike, you can make one additional unarmed strike as part of that action." },
      { level: 15, name: "Iron Fists", description: "Your unarmed strikes count as magical for overcoming resistance, and their damage die increases to 1d10." },
    ],
  },
  {
    id: "the-spirit-fused",
    classId: "fighter",
    name: "The Spirit-Fused",
    synopsis: "A fighter bonded with a supernatural spirit companion that manifests to aid them in combat.",
    hint: "Good if you want a fighter with mystical flavor and a spirit partner to channel",
    source: "Obojima",
    features: [
      { level: 3, name: "Spirit Bond", description: "Choose a spirit that grants you a cantrip and a unique combat feature tied to its nature." },
      { level: 7, name: "Spirit Surge", description: "Spend Hit Dice to power up your spirit's abilities, enhancing their effects for a short time." },
      { level: 10, name: "Manifest Spirit", description: "Your spirit appears as a physical presence beside you, aiding your attacks and defenses." },
      { level: 15, name: "Spirit Apotheosis", description: "Temporarily fuse with your spirit, gaining flight and damage resistances for a short duration." },
    ],
  },
  {
    ...
    synopsis: "A scholar of death's mysteries who grows stronger each time they bring a creature to its end.",
    hint: "Good if you want a dark, morbid monk who feeds on the deaths of foes",
    source: "Sword Coast",
    features: [
      { level: 3, name: "Touch of Death", description: "When you reduce a creature to 0 hit points, gain temporary hit points equal to your Wisdom modifier plus your monk level." },
      { level: 6, name: "Hour of Reaping", description: "As an action, force all creatures within 30 feet to make a Wisdom save or become frightened of you." },
      { level: 11, name: "Mastery of Death", description: "Spend 1 ki point to remain at 1 hit point instead of being reduced to 0." },
    ],
  },
  {
    ...
    synopsis: "A monk who harnesses elemental magic through ki-powered disciplines resembling spells.",
    hint: "Good if you want a monk that casts flashy elemental spells using ki",
    source: "PHB",
    features: [
      { level: 3, name: "Disciple of the Elements", description: "Learn elemental disciplines that let you spend ki to cast spells like Burning Hands or Thunderwave." },
      { level: 6, name: "Elemental Attunement", description: "Gain minor magical manipulation over the elements and learn additional disciplines." },
      { level: 11, name: "Greater Disciplines", description: "Access higher-level elemental spells and effects by spending more ki points." },
    ],
  },
  {
    ...
    synopsis: "A draconic martial artist who channels the elemental breath and majesty of dragons.",
    hint: "Good if you want a monk with dragon flavor, breath weapons, and flight",
    source: "Fizban's",
    features: [
      { level: 3, name: "Draconic Disciple", description: "You learn Draconic and your unarmed strikes can deal elemental damage instead of bludgeoning." },
      { level: 3, name: "Breath of the Dragon", description: "Replace your attacks with a breath weapon dealing elemental damage in a cone or line." },
      { level: 6, name: "Wings Unfurled", description: "When you use Step of the Wind, you gain a flying speed until the end of your turn." },
      { level: 11, name: "Aspect of the Wyrm", description: "As a bonus action, frighten nearby creatures or grant resistance to allies in a draconic aura." },
    ],
  },
  {
    id: "way-of-the-cobalt-soul",
    classId: "monk",
    name: "Way of the Cobalt Soul",
    synopsis: "A member of a monastic order of truth-seekers who break minds as easily as bones.",
    hint: "Good if you want a scholarly monk who extracts information and exposes weaknesses",
    source: "Critical Role",
    features: [
      { level: 3, name: "Extract Aspects", description: "When you hit a creature, you can learn its damage immunities, resistances, and vulnerabilities." },
      { level: 6, name: "Extort Truth", description: "Creatures struck by your Flurry of Blows are unable to speak deliberate lies for 1 minute." },
      { level: 6, name: "Mystical Erudition", description: "Learn two languages and gain expertise in Insight and Investigation." },
      { level: 11, name: "Mind of Mercury", description: "Spend ki points to take additional reactions on each round of combat." },
    ],
  },
  {
    id: "sheep-dragon-shepherd",
    classId: "monk",
    name: "Way of the Sheep Dragon Shepherd",
    synopsis: "A peaceful monk who channels guardian dragon spirits through graceful herding staff work.",
    hint: "Good if you want a protective, defensive monk with pastoral and dragon themes",
    source: "Obojima",
    features: [
      { level: 3, name: "Shepherd's Stance", description: "Spend ki to redirect attacks aimed at allies so they strike you instead." },
      { level: 3, name: "Guardian's Wool", description: "Build up a defensive aura of protective energy that cushions incoming blows." },
      { level: 6, name: "Flock's Fortitude", description: "Allies within 10 feet of you gain the benefit of your unarmored movement bonus." },
      { level: 11, name: "Dragon's Vigil", description: "Summon a spectral sheep dragon that fights alongside you for one minute." },
    ],
  },
  {
    ...
    synopsis: "A paladin sworn to uphold the law and protect the realm and its people above all else.",
    hint: "Good if you want a loyal defender paladin who keeps allies close and standing",
    source: "Sword Coast",
    features: [
      { level: 3, name: "Channel Divinity: Champion Challenge & Turn the Tide", description: "Force nearby enemies to remain close to you, or heal bloodied allies within 30 feet." },
      { level: 7, name: "Divine Allegiance", description: "As a reaction, transfer damage taken by a nearby ally to yourself instead." },
      { level: 15, name: "Unyielding Spirit", description: "Gain advantage on saving throws against being paralyzed or stunned." },
    ],
  },
  {
    id: "oath-of-thunder",
    ...
    synopsis: "A storm-sworn paladin who calls down lightning and thunder to smite enemies of the sky.",
    hint: "Good if you want a paladin that wields elemental storm magic alongside smites",
    source: "Kobold Press",
    features: [
      { level: 3, name: "Channel Divinity: Storm Strike & Thunderclap", description: "Your next attack deals extra thunder damage, or release a burst of thunder that pushes enemies away." },
      { level: 7, name: "Storm Aura", description: "A 10-foot aura deals lightning damage to enemies that end their turn inside it." },
      { level: 15, name: "Chain Lightning", description: "Your smite erupts as arcing lightning that leaps to strike multiple targets." },
    ],
  },
  {
    id: "oath-of-the-river",
    classId: "paladin",
    name: "Oath of the River",
    synopsis: "A paladin tied to flowing water, embodying healing, guidance, and relentless current.",
    hint: "Good if you want a supportive paladin themed around water, healing, and movement",
    source: "Obojima",
    features: [
      { level: 3, name: "Channel Divinity: Tide's Embrace & Healing Current", description: "Push enemies with a wave of water, or heal allies arranged along a flowing line." },
      { level: 7, name: "River's Blessing", description: "A 10-foot aura grants allies a swim speed and resistance to poison damage." },
      { level: 15, name: "Mantle of the Deep", description: "Transform into a living wave, gaining damage resistance and a flying speed." },
    ],
  },
  {
    id: "drakewarden",
    classId: "ranger",
    name: "Drakewarden",
    synopsis: "A ranger who forms a mystical bond with a small drake companion that grows in power alongside its master.",
    hint: "Good if you want a loyal dragon pet that scales from cute to fearsome over the campaign",
    source: "Fizban's",
    features: [
      { level: 3, name: "Draconic Gift & Drake Companion", description: "Learn the Thaumaturgy cantrip and summon a Tiny drake companion that can use a breath weapon." },
      { level: 7, name: "Bond of Fang and Scale", description: "Your drake grows to Small size, and you gain resistance to its damage type while it is summoned." },
      { level: 11, name: "Drake's Breath", description: "Your drake can use its action to exhale a 30-foot line of energy, dealing 8d6 damage of its type." },
      { level: 15, name: "Perfected Bond", description: "Your drake becomes Medium and gains a flying speed, and you share its damage resistance." },
    ],
  },
  {
    id: "corrupted-ranger",
    ...
    synopsis: "A ranger tainted by dark magic who hunts monsters by wielding the very corruption they represent.",
    hint: "Good if you want a dark, morally grey ranger who fights evil with necrotic power",
    source: "Kobold Press",
    features: [
      { level: 3, name: "Corrupted Favored Enemy", description: "Deal bonus necrotic damage to your favored enemies on your first hit each turn." },
      { level: 7, name: "Touch of Shadow", description: "When you cast a healing spell, you can also deal necrotic damage to a nearby enemy." },
      { level: 11, name: "Corrupted Resilience", description: "You gain resistance to necrotic and poison damage." },
      { level: 15, name: "Dark Apotheosis", description: "Once per day, transform into a shadow creature with a flying speed and enhanced dark powers." },
    ],
  },
  {
    id: "phantom",
    classId: "rogue",
    name: "Phantom",
    synopsis: "A rogue haunted by the spirits of the dead, channeling ghostly whispers into deadly psychic strikes.",
    hint: "Good if you want a spooky rogue who hits multiple targets with sneak attack and gains flexible skills",
    source: "Tasha's Cauldron",
    features: [
      { level: 3, name: "Whispers of the Dead & Wails from the Grave", description: "Gain a temporary skill proficiency after each rest, and your sneak attack can deal psychic damage to a second target." },
      { level: 9, name: "Tokens of the Departed", description: "Collect soul trinkets from dying creatures that grant you various benefits and knowledge." },
      { level: 13, name: "Ghost Walk", description: "Become incorporeal with a flying speed for up to 10 minutes, passing through creatures and objects." },
    ],
  },
  {
    id: "waxwork-rogue",
    classId: "rogue",
    name: "Waxwork Rogue",
    synopsis: "A rogue who crafts waxen duplicates and disguises to deceive foes and escape danger.",
    hint: "Good if you want a trickster rogue using decoys, disguises, and clever escapes",
    source: "Obojima",
    features: [
      { level: 3, name: "Wax Double", description: "Create a waxen decoy of yourself that can absorb attacks meant for you." },
      { level: 9, name: "Melting Escape", description: "When you Disengage, leave a puddle of wax behind that hinders pursuers." },
      { level: 13, name: "Masked Intent", description: "Use wax masks to cast Disguise Self at will, perfectly mimicking others." },
    ],
  },
  {
    id: "runechild",
    classId: "sorcerer",
    name: "Runechild",
    synopsis: "A sorcerer whose magical power manifests as glowing arcane runes branded upon their skin.",
    hint: "Good if you want a flashy sorcerer with defensive runes and a dramatic transformation capstone",
    source: "Explorer's Guide",
    features: [
      { level: 1, name: "Essence Runes & Glowing Runes", description: "Sorcery points manifest as glowing runes on your body that grant an AC bonus." },
      { level: 6, name: "Sigilic Augmentation", description: "Spend a rune to gain advantage on Strength, Dexterity, or Constitution checks." },
      { level: 14, name: "Arcane Exemplar Form", description: "Spend runes to transform, gaining flight, retribution damage, and bonus spell damage." },
    ],
  },
  {
    id: "oni-bloodline",
    classId: "sorcerer",
    name: "Oni Bloodline",
    synopsis: "A sorcerer descended from terrifying oni, growing tall, clawed, and fearsome as their power awakens.",
    hint: "Good if you want a melee-capable sorcerer who grapples and transforms into a towering oni",
    source: "Obojima",
    features: [
      { level: 1, name: "Oni Heritage", description: "Gain natural claw attacks, resistance to charm, and the ability to speak Giant." },
      { level: 6, name: "Fearsome Grasp", description: "Use a reaction to grapple and frighten creatures that attack you." },
      { level: 14, name: "Oni Transformation", description: "As a bonus action, grow larger, gaining extended reach and bonus damage on attacks." },
    ],
  },
  {
    id: "the-undying",
    classId: "warlock",
    name: "The Undying",
    synopsis: "Your patron is an ancient being that cheated death itself, granting you a sliver of its deathless nature.",
    hint: "Good if you want a resilient warlock who shrugs off death and never ages",
    source: "Sword Coast",
    features: [
      { level: 1, name: "Among the Dead & Expanded Spell List", description: "Learn Spare the Dying, and undead won't attack you unless you attack first." },
      { level: 6, name: "Defy Death", description: "Regain hit points when you succeed on a death saving throw, once per long rest." },
      { level: 10, name: "Undying Nature", description: "You become ageless and no longer need food, water, or air to survive." },
      { level: 14, name: "Indestructible Life", description: "As a bonus action, regain 1d8 + warlock level hit points and regrow missing body parts." },
    ],
  },
  {
    id: "the-undead",
    classId: "warlock",
    name: "The Undead",
    synopsis: "Your patron is a powerful lich or ghost from beyond the grave, sharing its dread mastery over death.",
    hint: "Good if you want a horror-themed warlock who frightens enemies and channels necrotic power",
    source: "Van Richten's",
    features: [
      { level: 1, name: "Form of Dread & Expanded Spell List", description: "As a bonus action, enter a dread form that frightens enemies and grants temporary hit points." },
      { level: 6, name: "Grave Touched", description: "Change your weapon damage to necrotic and reroll damage once per turn." },
      { level: 10, name: "Necrotic Husk", description: "Gain immunity to necrotic damage and explode in necrotic energy when dropped to 0 HP." },
      { level: 14, name: "Spirit Projection", description: "Project an astral form that flies, heals via vampirism, and teleports between locations." },
    ],
  },
  {
    id: "the-lantern",
    classId: "warlock",
    name: "The Lantern",
    synopsis: "Your patron is a spiritual lantern bearer who guides lost souls through the darkness of the afterlife.",
    hint: "Good if you want a support warlock who buffs allies and communes with the dead",
    source: "Obojima",
    features: [
      { level: 1, name: "Lantern's Light", description: "Summon a guiding light that grants nearby allies advantage on saving throws." },
      { level: 6, name: "Guiding Flame", description: "Use your lantern to grant an ally a bonus on their next attack roll." },
      { level: 10, name: "Soul Warden", description: "Cast Speak with Dead at will, and the ghosts must answer your questions truthfully." },
      { level: 14, name: "Eternal Beacon", description: "Cast Daylight at will and grant resistance to radiant and necrotic damage within its area." },
    ],
  },
  {
    id: "school-of-geomancy",
    classId: "wizard",
    name: "School of Geomancy",
    synopsis: "An earth-magic wizard who shapes stone and terrain to control the battlefield and fortify allies.",
    hint: "Good if you want a wizard who manipulates terrain, creates cover, and becomes an earth elemental",
    source: "Kobold Press",
    features: [
      { level: 2, name: "Stone Cantrip & Geomantic Focus", description: "Learn Mold Earth and cast earth-based spells at reduced cost." },
      { level: 6, name: "Terrain Manipulation", description: "Cast Move Earth as a ritual and create cover from raised stone." },
      { level: 10, name: "Stone Stance", description: "Gain an AC bonus and damage resistance while standing on earth or stone." },
      { level: 14, name: "Earth's Champion", description: "Merge with stone for 1 minute, becoming a 10-foot-tall earth elemental." },
    ],
  },
  {
    id: "origami-mage",
    classId: "wizard",
    name: "Origami Mage",
    synopsis: "A wizard who folds paper into magical constructs, weapons, and forms. Their art transforms simple sheets into instruments of wonder and war.",
    hint: "Good if you want a whimsical, crafty caster with unique construct and transformation flavor",
    source: "Obojima",
    features: [
      { level: 2, name: "Paper Familiar", description: "Fold a paper crane familiar that can deliver messages and carry your spells to distant targets." },
      { level: 6, name: "Origami Arsenal", description: "Fold paper into weapons and shields that grant bonuses to AC and damage rolls." },
      { level: 10, name: "Living Origami", description: "Create Tiny paper constructs that animate and fight alongside you in battle." },
      { level: 14, name: "Grand Folded Form", description: "Fold yourself into a massive origami creature, gaining flight and damage resistance." },
    ],
  },
  {
    ...
    synopsis: "Blood hunters dedicated to destroying undead and incorporeal horrors. They channel radiant power through their cursed blades.",
    hint: "Good if you want a focused undead hunter who shines against ghosts, wraiths, and the restless dead",
    source: "Critical Role",
    features: [
      { level: 3, name: "Rite of the Dawn", description: "Your weapon deals radiant damage and gains bonus damage against undead creatures." },
      { level: 7, name: "Supernal Surge", description: "Gain advantage on attacks against undead and can see through invisibility." },
      { level: 11, name: "Brand of Sundering", description: "Your brand prevents targets from teleporting or becoming incorporeal." },
      { level: 15, name: "Gravesight", description: "Gain truesight out to 60 feet, and critical hits against undead deal maximum damage." },
    ],
  },
  {
    ...
    synopsis: "Blood hunters who embrace the lycanthropic curse, transforming into feral hybrid forms in battle. They walk the razor edge between control and savagery.",
    hint: "Good if you want a shapeshifting melee bruiser with claws, resistances, and a beastly edge",
    source: "Critical Role",
    features: [
      { level: 3, name: "Heightened Senses and Hybrid Transformation", description: "Gain advantage on Perception checks and can transform into a hybrid beast form with claws and damage resistances." },
      { level: 7, name: "Stalker's Prowess", description: "In hybrid form, your movement speed increases and you can leap much farther than normal." },
      { level: 11, name: "Advanced Transformation", description: "Your hybrid form grants an extra attack and natural regeneration each turn." },
      { level: 15, name: "Hybrid Transformation Mastery", description: "You fully master your curse, gaining immunity to disease and advantage on saves to resist transformation effects." },
    ],
  },
  {
    ...
    synopsis: "Blood hunters who inject alchemical mutagens to warp their bodies for combat. Each dose offers power at the cost of dangerous side effects.",
    hint: "Good if you want a self-experimenting alchemist warrior who customizes buffs each day",
    source: "Critical Role",
    features: [
      { level: 3, name: "Mutagencraft", description: "Craft and imbibe mutagens that grant combat bonuses along with temporary side effects." },
      { level: 7, name: "Strange Metabolism", description: "Gain advantage on saves against poison and can remove a mutagen side effect on yourself." },
      { level: 11, name: "Exquisite Technique", description: "You can drink and benefit from multiple mutagens at the same time." },
      { level: 15, name: "Robust Physiology", description: "Gain immunity to disease and a permanent AC bonus from your mutations." },
    ],
  },
  {
    ...
    synopsis: "Blood hunters bonded to a fiendish patron who grants them dark magic alongside their martial rites. They wield spell and blade in equal measure.",
    hint: "Good if you want a half-caster blood hunter blending warlock spells with weapon strikes",
    source: "Critical Role",
    features: [
      { level: 3, name: "Pact Magic and Rite Focus", description: "Learn warlock cantrips and spells, and your weapon serves as your spellcasting focus." },
      { level: 7, name: "Mystic Frenzy", description: "When you take the Attack action, you can also cast a cantrip as part of the same action." },
      { level: 11, name: "Revealed Arcana", description: "Cast a powerful fiend-themed spell once per long rest without expending a spell slot." },
      { level: 15, name: "Brand of the Sappheros", description: "Mark a target with your brand to regain hit points whenever you deal damage to them." },
    ],
  },
  {
    ...
    synopsis: "Illriggers who plan devastation like generals, orchestrating their allies into precise tactical strikes. Every battlefield becomes a blueprint for destruction.",
    hint: "Good if you want a tactical support leader who empowers the whole party on marked targets",
    source: "MCDM",
    features: [
      { level: 3, name: "Infernal Tactics", description: "Grant allies bonus damage when they attack your marked targets." },
      { level: 9, name: "Battlefield Control", description: "Use a reaction to reposition enemies within 30 feet, shaping the fight to your advantage." },
      { level: 13, name: "Grand Design", description: "Once per rest, grant all allies an extra attack against a marked target." },
    ],
  },
  {
    id: "painkiller",
    classId: "illrigger",
    name: "Painkiller",
    synopsis: "Brutal enforcers who thrive on the suffering of their enemies, growing stronger from every wound they inflict. They are nightmares for the injured and the weak.",
    hint: "Good if you want an aggressive frontliner who punishes wounded enemies and tanks through damage",
    source: "MCDM",
    features: [
      { level: 3, name: "Sadistic Strike", description: "Deal bonus damage against creatures that are already wounded or below full hit points." },
      { level: 9, name: "Infernal Resilience", description: "Gain temporary hit points whenever you deal damage with a weapon attack." },
      { level: 13, name: "Wound Exploitation", description: "Your critical hits impose a level of exhaustion on the target." },
    ],
  },
  {
    id: "shadowmaster",
    classId: "illrigger",
    name: "Shadowmaster",
    synopsis: "Illriggers who strike from darkness, blending infernal power with shadowy stealth. They vanish between moments to deliver lethal blows.",
    hint: "Good if you want a stealthy assassin-style illrigger who teleports through shadows",
    source: "MCDM",
    features: [
      { level: 3, name: "Cloak of Shadow", description: "As a bonus action, wreathe yourself in shadows to gain advantage on Stealth and your first attack." },
      { level: 9, name: "Step of Shadows", description: "Teleport between areas of darkness up to 60 feet away." },
      { level: 13, name: "Shadow Assassin", description: "Your sneak attacks deal bonus necrotic damage and blind targets on a critical hit." },
    ],
  },
];
