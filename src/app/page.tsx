...
export default function Home() {
  return (
    <main className="relative min-h-screen isolate">
      ...
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(99,102,241,0.15),_transparent_50%),radial-gradient(ellipse_at_bottom_right,_rgba(139,92,246,0.12),_transparent_45%),radial-gradient(ellipse_at_top_left,_rgba(251,191,36,0.10),_transparent_35%)]" />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <h1 className="font-heading text-4xl font-bold text-amber-400 text-glow sm:text-5xl lg:text-6xl">
